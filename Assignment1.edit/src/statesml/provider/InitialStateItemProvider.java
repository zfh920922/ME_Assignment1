...
/**
 * This is the item provider adapter for a {@link statesml.InitialState} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_InitialState_isInitial_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_InitialState_isInitial_feature", "_UI_InitialState_type"),
				 StatesmlPackage.Literals.INITIAL_STATE__IS_INITIAL,
				 true,
				 false,
				 false,
	...
	protected void addInitialStatePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_InitialState_initialState_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_InitialState_initialState_feature", "_UI_InitialState_type"),
				 StatesmlPackage.Literals.INITIAL_STATE__INITIAL_STATE,
				 true,
				 false,
				 true,
				 null,
