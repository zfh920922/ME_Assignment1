...
/**
 * This is the item provider adapter for a {@link statesml.Function} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class FunctionItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 StatesmlPackage.Literals.FUNCTION__NAME,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(StatesmlPackage.Literals.FUNCTION__IN_PARAMETER);
			childrenFeatures.add(StatesmlPackage.Literals.FUNCTION__RETURN_PARAMETER);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(StatesmlPackage.Literals.FUNCTION__IN_PARAMETER,
				 StatesmlFactory.eINSTANCE.createParameter()));

		newChildDescriptors.add
			(createChildParameter
				(StatesmlPackage.Literals.FUNCTION__RETURN_PARAMETER,
				 StatesmlFactory.eINSTANCE.createParameter()));
	}
	...
	public String getCreateChildText(Object owner, Object feature, Object child, Collection<?> selection) {
		...
		boolean qualify =
			childFeature == StatesmlPackage.Literals.FUNCTION__IN_PARAMETER ||
			childFeature == StatesmlPackage.Literals.FUNCTION__RETURN_PARAMETER;
