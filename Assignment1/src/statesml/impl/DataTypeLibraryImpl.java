 ...
 * </p>
 * <ul>
 *   <li>{@link statesml.impl.DataTypeLibraryImpl#getName <em>Name</em>}</li>
...
public class DataTypeLibraryImpl extends MinimalEObjectImpl.Container implements DataTypeLibrary {
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, StatesmlPackage.DATA_TYPE_LIBRARY__NAME, oldName, name));
	}
